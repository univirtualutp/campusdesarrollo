...
/**
 * A drawer based layout for the boosted theme.
 *
...
// Footer.
$footerblocks = $PAGE->theme->settings->footerlayout;
...
echo $OUTPUT->render_from_template('theme_boosted/drawers', $templatecontext);
